...
const src_1 = require("did-jwt/src");
async function createVerifiableCredentialJwt(payload, issuer, options = {}) {
    ...
    return src_1.createJWT(parsedPayload, {
        ...options,
...
async function verifyCredential(vc, resolver, options = {}) {
    const verified = await src_1.verifyJWT(vc, { resolver, ...options });
...
async function verifyPresentation(presentation, resolver, options = {}) {
    const verified = await src_1.verifyJWT(presentation, { resolver, ...options });
